...
public class VoxReader {
    ...
    */
    ...
    private static int[] voxRGBAColors = new int[]{
        ...
        if (magic.equals("VOX ")) {
            ...
            while (stream.getPosition() < stream.getLength()) {
                ...
                if(chunkName.equals("PACK")) {
                    int numModels=stream.ReadInt32(); //num of SIZE and XYZI chunks
                    if(numModels!=1) throw new IllegalArgumentException("reading vox file with multiple models not supported");
                ...
                // there are only 2 chunks we only care about, and they are SIZE and XYZI
                    ...
                    for (int i = 0; i < 256; i++) {
                        ...
                        rgbacolors[i]= 	(r  << 24) | (g << 16) | (b << 8) | a; //rgba888 color format used in libgdx
